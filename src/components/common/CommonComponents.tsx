            ...
            <Grid container spacing={2} direction="column" justifyContent="center" alignItems="center">
                <Grid item>
                    <Typography variant="h5">
                        External Secret Operator was not detected on your cluster. If you haven't already, please install it.
                    </Typography>
                </Grid>
                <Grid item>
                    <Typography>
...
export function ExternalSecretsOperatorInstallCheck({ children, fallback }: ExternalSecretsOperatorInstallCheckProps) {
    const { isExternalSecretsOperatorInstalled, isExternalSecretsOperatorCheckLoading } = useExternalSecretsOperatorInstalled();
