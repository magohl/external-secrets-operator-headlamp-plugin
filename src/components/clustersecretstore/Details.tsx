...
function renderProviderDetails(item: ClusterSecretStore) {
...
export function ClusterSecretStoreDetail(props: { namespace?: string; name?: string }) {
      ...
      <DetailsGrid
        ...
        extraInfo={item =>
          item && [
            {
              name: 'API Version',
              value: ClusterSecretStore.apiVersion,
            },
            {
              name: 'Kind',
              value: ClusterSecretStore.kind,
            },
            {
              name: 'Provider',
              value: (
                <Chip label={item.providerType} color="primary" variant="outlined" size="small" />
              ),
            },
            {
              name: 'Ready',
...
export default ClusterSecretStoreDetail;
